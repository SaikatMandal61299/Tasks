...
import 'package:quiz_major_project/main.dart';
import 'package:quiz_major_project/models/category.dart';
import 'package:quiz_major_project/ui/widgets/quiz_options.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Future<bool> _onBackPressed() {
      return showDialog(context: context, builder: (context) => AlertDialog(
        title: Text("Are you really want to go back to welcome page?"),
        actions: [
