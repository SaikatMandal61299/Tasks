...
import 'package:quiz_major_project/models/category.dart';
import 'package:quiz_major_project/models/question.dart';
import 'package:quiz_major_project/resources/api_provider.dart';
import 'package:quiz_major_project/ui/pages/error.dart';
import 'package:quiz_major_project/ui/pages/quiz_page.dart';
              ...
              child: Wrap(
                ...
                children: <Widget>[
                  ...
                  ActionChip(
                    ...
                    backgroundColor: _noOfQuestions == 10 ? Colors.redAccent : Colors.grey.shade600,
                    onPressed: () => _selectNumberOfQuestions(10),
                  ),
                  ActionChip(
                    label: Text("20"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _noOfQuestions == 20 ? Colors.redAccent : Colors.grey.shade600,
                    onPressed: () => _selectNumberOfQuestions(20),
                  ),
                  ActionChip(
                    label: Text("30"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _noOfQuestions == 30 ? Colors.redAccent : Colors.grey.shade600,
              ...
              child: Wrap(
                ...
                children: <Widget>[
                  ...
                  ActionChip(
                    label: Text("Any"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _difficulty == null ? Colors.redAccent : Colors.grey.shade600,
                    onPressed: () => _selectDifficulty(null),
                  ),
                  ActionChip(
                    label: Text("Easy"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _difficulty == "easy" ? Colors.redAccent : Colors.grey.shade600,
                    onPressed: () => _selectDifficulty("easy"),
                  ),
                  ActionChip(
                    label: Text("Medium"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _difficulty == "medium" ? Colors.redAccent : Colors.grey.shade600,
                    onPressed: () => _selectDifficulty("medium"),
                  ),
                  ActionChip(
                    label: Text("Hard"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _difficulty == "hard" ? Colors.redAccent : Colors.grey.shade600,
